...
public:
	...
	virtual void handleCallvoteInfoString( unsigned configStringNum, const wsw::StringView &string ) = 0;
	virtual void handleGametypeOptionString( unsigned configStringNum, const wsw::StringView &string ) = 0;
};
