...
void SCR_StopCinematic( void ) {
	...
	CIN_Close( (cinematics_s *)cl.cin.h );
...
static void SCR_ReadNextCinematicFrame( void ) {
	if( cl.cin.yuv ) {
		cl.cin.cyuv = CIN_ReadNextFrameYUV( (cinematics_s *)cl.cin.h,
		...
		cl.cin.pic = CIN_ReadNextFrame( (cinematics_s *)cl.cin.h,
										&cl.cin.width, &cl.cin.height,
										&cl.cin.aspect_numerator, &cl.cin.aspect_denominator,
										&cl.cin.redraw );
	}
...
void SCR_RunCinematic( void ) {
	...
	CIN_AddRawSamplesListener( (cinematics_s *)cl.cin.h, NULL,
							   &SCR_CinematicRawSamples, &SCR_CinematicGetRawSamplesLength );

	if( !CIN_NeedNextFrame( (cinematics_s *)cl.cin.h, SCR_CinematicTime() - cl.cin.startTime ) ) {
		cl.cin.redraw = false;
		return;
	}
...
static void SCR_PlayCinematic( const char *arg, int flags ) {
	...
	char *name = (char *)alloca( name_size );
